...
If foodborne illness and crop progress statistics could be combined and analyzed together with the same package, it would be much easier for orgnaizations such as the FDA to predict the 
