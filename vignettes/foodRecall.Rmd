...
```{r loo, echo=FALSE, fig.cap="*Example of shiny app tabular data for Miami, Florida*", out.width = '100%'}
...
```{r help, echo=FALSE, fig.cap="*Current Ongoing Recalls initiating on January 1st, 2023*", out.width = '100%'}
