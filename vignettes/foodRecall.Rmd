...
```{r pressure, echo=FALSE, fig.cap="An example of the tabular output of recalls from Garden Fresh Foods in Milwaukee using the recall_location function", out.width = '100%'}
...
that were reported for the first 4 months of 2015 and ending in June of 2015. Other input options include the date of recall initiation, the current status of the recall, and the distribution pattern of the recall. This makes it easy and efficient to see the status of any current or past recalls that might have had an impact at a certain time.
